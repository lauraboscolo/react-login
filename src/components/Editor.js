...
class Editor extends Component {
  ...
  publishStory () {
    ...
    formdata.append('author_id', this.props.candidate._id)
    ...
    axios.post(`${_url}post`, /*{
      ...
      author_id: this.props.candidate._id
    }*/formdata).then((res) => {
      this.setState({
        loading: false
      })
      ...
      <div className="row animated fadeInUp" data-animation="fadeInUp-fadeOutDown">
          <div id="main-post" className="col-xs-10 col-md-8 col-md-offset-2 col-xs-offset-1 main-content">
              <div className="post-metadata">
                  <img alt={this.props.candidate.name} className="avatar-image" src={this.props.candidate.provider_pic} height="40" width="40" />
                  <div className="post-info">
                      <div data-react-className="PopoverLink" data-react-props="{&quot;candidate_id&quot;:608,&quot;url&quot;:&quot;/candidates/netk&quot;,&quot;children&quot;:&quot;netk&quot;}"><span className="popover-link" data-reactroot=""><a href="">{this.props.candidate.name}</a></span></div>
                      <small>{this.props.candidate.email}</small>
                  </div>
              </div>
