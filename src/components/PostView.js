                ...
                <div className="row animated fadeInUp" data-animation="fadeInUp-fadeOutDown">
                    <div id="main-post" className="col-xs-10 col-md-8 col-md-offset-2 col-xs-offset-1 main-content">
                        ...
                        <div className="pull-right">
                            {this.props.candidate ? <FollowButton candidate={`${this.props.candidate.following}`} to_follow={`${author_id}`} /> : ''}
                        </div>

                        <div className="post-metadata">
                            <img alt={author_name} className="avatar-image" src={author_img} height="40" width="40" />
                            <div className="post-info">
                                <div data-react-className="PopoverLink" data-react-props="{&quot;candidate_id&quot;:608,&quot;url&quot;:&quot;/candidates/netk&quot;,&quot;children&quot;:&quot;netk&quot;}"><span className="popover-link" data-reactroot=""><a href={`/profile/${author_id}`}>{author_name}</a></span></div>
                        ...
                        <div className="author-info">
                            <div clas="author-metadata">
                                ...
                                <div className="candidatename-description">
                                    <h4>{author_name}</h4>
                                    <p></p>
                                </div>
                            </div>
                        ...
                        <div className="post-list-item">
                            <div className="flex-container">
                                ...
                                <div className="post-info">
                                    ...
                                    <small className="pli-candidatename"><a href="#"></a></small>
                                </div>
                            </div>
                        </div>
                ...
                <div className="post-metadata-bar" data-page="post-metadata-bar">
                    <div className="flex-container is-inView" data-behavior="animated-metadata">
                        ...
                        <div className="metabar-author-info flex-container flex-space-btw">
                            ...
                            <div data-react-className="CandidateFollowButton" >
                                {this.props.candidate ? <FollowButton candidate={`${this.props.candidate.following}`} to_follow={`${author_id}`} /> : ''}
                            </div>
                        </div>
                    </div>
